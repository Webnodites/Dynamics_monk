                                            ...
                                            <form id="fupForm" name="form1" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <input type="file" name="cimg" id="cimg" class="filestyle" data-buttonbefore="true"  onchange="readURL(this);">
                                                    <img src="#" id="blah" alt="Selected Image Here.." style="height: auto;width: 150px;margin-top: 20px;">
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" id="cdate" name="cdate" value="<?php echo $date;?>" >
                                                </div>
