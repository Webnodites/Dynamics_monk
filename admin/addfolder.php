...
$file= $_FILES["folderimg"]["name"];
$date = date('d-m-Y h:i:sa');

$z= "INSERT INTO `gallery`(`folderName`, `foldermainimg`,`whenentered`, `isActive`)
               VALUES ('$name','$file','$date','True')";


$res = mysqli_query($con,$z);
if($res)
{
$a5=move_uploaded_file($_FILES["folderimg"]["tmp_name"],"../images/folder/".$_FILES["folderimg"]["name"]);
                ...
                <div class="content">
                    ...
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Add Gallery Folder</h4>
                        </div>
                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="addfolder.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="foldername" id="exampleInputEmail1" placeholder="Enter Folder Name">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button type="submit" name="addfolder" class="btn themebtn waves-effect waves-light">Add</button>
                                            </form>
                                        </div><!-- card-body -->
                                    </div> <!-- card -->
                                </div> <!-- col-->
