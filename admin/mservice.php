                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="m-t-0">Add Main Service </h4>
                                            <form id="fupForm" name="form1" method="post">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="sname" id="sname" placeholder="Enter Service Name">
                                                </div>
                                                 
                                                <button type="submit" class="btn themebtn waves-effect waves-light" id="addser">Add</button>
                                            </form>
                                        </div><!-- card-body -->
                                    </div> <!-- card -->
                                </div> <!-- col-->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="m-b-30 m-t-0">All Services</h4>
                                            <div class="row">
    ...
    <div class="modal-content">
      ...
      <form action="delete.php" method="post">
          ...
          <div class="modal-footer">
            <button type="submit" name = 'delete_ser' class="btn yes">Yes</button>
