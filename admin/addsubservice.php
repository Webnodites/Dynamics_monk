...
$z= "INSERT INTO `subservice`(`s_id`, `sub_name`, `sub_content`, `isActive`) VALUES($sname, '$subname','$subdesc','True')";
                ...
                <div class="content">
                    ...
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Add Sub-Service</h4>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="addsubservice.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Sub-Service Name</label>
                                                    <input type="text" class="form-control" name="subname" id="" placeholder="Enter Sub-Service Name">
                                                </div>
                                               ...
                                               <div class="form-group">
                                                <label for="exampleInputEmail1">Sub-Service Content </label>
                                                    <textarea id="editor" name="sub_desc" rows="30" ></textarea>
                                                
                                                </div>

                                                
                                                <button type="submit" name="addsubservice" class="btn themebtn waves-effect waves-light">Add</button>
                                            </form>
                                        </div><!-- card-body -->
                                    </div> <!-- card -->
                                </div> <!-- col-->
