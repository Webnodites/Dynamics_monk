...
<body>
    ...
    <main class="site-main">
        ...
        <div class="slider-section">
            <ul class="bxslider">
                <li class="slide-1">
                    <img  src="images/banner/b1.jpg" alt="banner" />
                    <div class="container">
                        <div class="sliderbanner-content">
                            <h1>Innovative, scalable software development solutions</h1>
                        </div>
                    </div>
                </li>
                <li class="slide-2">
                    <img  src="images/banner/b2.jpg" alt="banner" />
                    <div class="container">
                        <div class="sliderbanner-content">
                            <h2>Innovative, scalable software development solutions</h2>
                        </div>
                    </div>
                </li>
                <li class="slide-3">
                    <img  src="images/banner/b3.jpg" alt="banner" />
                    <div class="container">
                        <div class="sliderbanner-content">
                            <h2>Innovative, scalable software development solutions</h2>
                        </div>
        ...
        <div class="technologies-block-section">
            ...
            <div class="container">
               ...
               <!--  <div class="technology-blocks">
                    <div class="technology-block one">
                        <img data-src="images/home/tech-logo1.png" class="lazyload" alt="Java">
                        <ul>
                            <li>J2EE</li>
                            <li>Python</li>
                            <li>Scala</li>
                    ...
                    <div class="technology-block two">
                        <img data-src="images/home/tech-logo2.png" class="lazyload" alt="bigdata">
                        <ul>
                            <li>Hadoop</li>
                            <li>Apache Spark</li>
                            <li>Hortonworks</li>
                    ...
                    <div class="technology-block three">
                        <img data-src="images/home/tech-logo3.png" class="lazyload" alt="Microsoft Dynamics">
                        <ul>
                            <li>Dynamics 365</li>
                            <li>Dynamics AX</li>
                            <li>Dynamics CRM</li>
                    ...
                    <div class="technology-block four">
                        <img data-src="images/home/tech-logo4.png" class="lazyload" alt="Mobility">
                        <ul>
                            <li>iOS</li>
                            <li>Android</li>
                            <li>Xamarin</li>
                    ...
                    <div class="technology-block five">
                        <img data-src="images/home/tech-logo5.png" class="lazyload" alt="Opensource">
                        <ul>
                            <li>Magento</li>
                            <li>Laravel</li>
                        </ul>
        ...
        <div class="home-about">
            <div class="container">
                ...
                <a href="contact.html" class="abtn">
                                    <span>Contact Us</span>
        ...
        <div class="container">
            <div class="case-study-section">
                <div class="case-study">
                    ...
                    <div class="csboxes">
                        <div class="csbox">
                            <h3><a href="casestudy/bigdata/etl-solution-financial-services-groups.html">Lorem ipsum dolor sit amet</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                        <div class="csbox">
                            <h3><a href="casestudy/bigdata/etl-solution-financial-services-groups.html">Lorem ipsum dolor sit amet</a></h3>
                ...
                <div class="case-study">
                    ...
                    <div class="csboxes">
                        <div class="csbox fullwidth">
                            ...
                            <a class="readmore_btn" href="articles/know-before-choosing-the-right-data-warehouse-for-bi.html">Read More</a>
                        </div>
                    </div>
                </div>
            </div> -->
