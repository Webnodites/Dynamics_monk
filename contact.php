...
<body>
    ...
    <main class="site-main">
        ...
        <!-- PageBanner -->
        <div class="pagebanner-section contactus_pagebanner banner_mainpage">
            <div class="container">
        ...
        <!-- Contact Us Block -->
        <div class="contactus-block-section">
            <div class="container">
                <div class="row">
                    <div class="contactus-page-block">
                        <div class="contactus-page-box">
                            <div class="section-header">
                                <h3>We would love to hear from you</h3>
                            </div>
                            <form class="contactpage_form">
                                <div class="row">
                                    <div class="form-group halfwidth">
                                        <input class="form-control" placeholder="First Name*" id="txtFName" name="txtFName" type="text" />
                                    </div>
                                    <div class="form-group halfwidth">
                                        <input class="form-control" placeholder="Last Name*" id="txtLName" name="txtLName" type="text" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Business Email*" id="txtCEmail" name="txtEmail" type="email" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Phone" type="text" id="txtCPhone" name="txtPhone" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Company*" type="text" id="txtCCompany" name="txtCCompany" />
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Requirement" id="txtCMessage" name="txtCMessage"></textarea>
                                </div>
                                
                               
                                <div class="form-group">
                                    <button type="button" value="Submit" name="btnSubmit" id="btnCSubmit" class="btn_submit">Submit</button>
                                </div>

                            </form>
                        </div>
                        <div class="contactus-page-box">
                            <div class="contactus-page-innerbox">
                                <div class="section-header">
                                    <h3>Address</h3>
                                </div>
                                <div class="contactus-details">
                                    ...
                                    <a href="tel:+123456789"><i class="fa fa-phone" aria-hidden="true"></i>+123456789</a>
